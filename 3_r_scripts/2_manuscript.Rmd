---
title: "Between-individual and within-individual variation in the shape of eggs in tree swallows (*Tachycineta bicolor*)."
author: 
 - Conor C. Taff
 - Thomas A. Ryan
 - Maren N. Vitousek
...
```{r summary-plot, echo = FALSE, message = FALSE, warning = FALSE, fig.width = 4.5, fig.height = 3, fig.cap = "Morphospace of tree swallow egg shapes from 1435 measured eggs. Black ellipse indicates the region containing 90% of eggs. Diamond is the overall average egg shape for tree swallows from this study. The red ellipse contains 90% of the species average egg shapes from 1400 bird species included in Stoddard et al. 2017."}
...
Comparative studies should post the measurements of individual eggs rather than just the species means. Often unclear how measurements of eggs from the same clutch are accounted for or are they just counted as independent data points?
...
Possible that size trumps shape within a species like TRES - producing different size eggs seems tightly linked to shape and so shape variation might just be a by product of different investment. Then the question is why so much variation in investment that is consistent (not plastic) within individuals? While this is an interesting question, lots of research does address this point: 
